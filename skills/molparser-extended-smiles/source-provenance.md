...
The original internal source document for Extended-SMILES 2.0 was authored in Chinese.

For this repository, operational guidance has been normalized into English-first files:

- `SKILL.md`
- `extended-smiles-spec.md`
- `figure-index.md`
